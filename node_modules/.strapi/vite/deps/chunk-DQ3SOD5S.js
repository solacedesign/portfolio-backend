...
import {
  LimitsModal
} from "./chunk-3AV7AZT7.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-TQNFYFKF.js";
import {
  getStageColorByHex
} from "./chunk-RCW4U6TM.js";
import {
...
} from "./chunk-7FKQZHO7.js";
import {
  useTypedSelector
} from "./chunk-WYIFJTEX.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-CKNI3O63.js";
import {
  PERMISSIONS as PERMISSIONS5,
  ReleaseActionMenu,
  ReleaseActionOptions,
  pluginId as pluginId4
} from "./chunk-UVPT7Z34.js";
import {
  index
} from "./chunk-WPPZWX4F.js";
import {
  getTimezoneOffset,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-4KCS6XE2.js";
import {
  useConfig
} from "./chunk-ONVRVBQ5.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-4KYMBCCA.js";
import {
  useDocumentActions
} from "./chunk-FQWFM6RA.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-BSVBHESH.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  renderAdmin
} from "./chunk-MLDZODJM.js";
import {
  useLicenseLimits
} from "./chunk-AGIQEOXA.js";
import {
  require_omit
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-BPTA6DG4.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-IUERFYRH.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-AAZ4AS6U.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-FPQ6CJM2.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-MDXVQ6TK.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ZC6WANDC.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-XZQKSJRS.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-NSJMCLGK.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-P2A4CBX4.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-MTBABH76.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-YRCBJFKB.js");
          return {
...
//# sourceMappingURL=chunk-DQ3SOD5S.js.map
