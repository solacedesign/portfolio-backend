import {
  reducer
} from "./chunk-PD7BZCZJ.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-XAXCAMPU.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/fr.json":
      return import("./fr.json-CDL6IA6Z.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-6HCJGURU.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-IZM7HYL4.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-IZM7HYL4.js");
...
//# sourceMappingURL=chunk-WPPZWX4F.js.map
